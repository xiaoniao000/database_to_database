...
def selectSql_b2(request):
    ...
    select_sql = "SELECT " + word_id + "," + word_title + "," + word_score + "," + word_input + "," + word_output + " FROM " + table1 + "," + table2 + " WHERE " + equal1 + "=" + equal2 + ";"
    ...
    select_sql2 = "SELECT " + word_t_id + "," + word_id + "," + word_input + "," + word_output + " FROM " + table1 + "," + table2 + " WHERE " + equal1 + "=" + equal2 + ";"
...
def selectSql_t1(request):
    ...
    sql = "SELECT " + word_id + "," + word_title + "," + word_score + "," + word_value + " FROM " + table + ";"
    return sql
...
def selectSql_t2(request):
    ...
    equal1 = '' + table1 + '.' + equal1
    equal2 = '' + table2 + '.' + equal2
    sql = "SELECT " + word_id + "," + word_title + "," + word_score + "," + word_value + " FROM " + table1 + "," + table2 + " WHERE " + equal1 + "=" + equal2 + ";"
    return sql
